...
public class DbRepositoryImp implements Repository {
	...
	private static Logger log = Logger.getLogger(DbRepositoryImp.class);
	...
	public void save(Map<Integer, Player> playerList) {
		...
		try {
			...
			throw new CustomRuntimeException("Saving " + gameId + " results failed: " + e);
		} finally {
	...
	public void delete(String gameId) {
		...
		try {
			...
			throw new CustomRuntimeException("Deleting " + gameId + " failed: " + e);
		} finally {
			closeConnection(connection);
		}
	}
	...
	public List<GameResults> allGameResults() {
		...
		try {
			...
			throw new CustomRuntimeException("Returning list of games failed: " + e);
		} finally {
			closeConnection(connection);
		}
	...
	public List<Player> gameResultDetails(String gameId) {
		...
		try {
			...
			throw new CustomRuntimeException("Returning " + gameId + " results failed: " + e);
		} finally {
			closeConnection(connection);
		}
